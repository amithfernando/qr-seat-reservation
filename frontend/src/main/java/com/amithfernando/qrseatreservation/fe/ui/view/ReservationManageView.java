package com.amithfernando.qrseatreservation.fe.ui.view;

import com.amithfernando.qrseatreservation.fe.core.model.ReservationDetail;
...
import com.amithfernando.qrseatreservation.fe.core.model.SellerDetail;
import com.amithfernando.qrseatreservation.fe.core.model.TableDetail;
import com.amithfernando.qrseatreservation.fe.core.service.ReservationService;
import com.amithfernando.qrseatreservation.fe.core.service.SellerDetailService;
import com.amithfernando.qrseatreservation.fe.core.service.TableDetailService;
import com.amithfernando.qrseatreservation.fe.ui.view.component.ReservationViewDialogComponent;
import com.amithfernando.qrseatreservation.fe.ui.view.layout.MainLayout;
import com.amithfernando.qrseatreservation.fe.ui.view.layout.PageLayout;
...
import com.amithfernando.qrseatreservation.fe.core.enums.TicketType;
import java.util.Set;
import java.util.HashSet;
import java.util.List;
import java.util.stream.Collectors;
import com.amithfernando.qrseatreservation.fe.core.enums.ReservationStatus;
...
public class ReservationManageView extends PageLayout {
    ...
    private final ReservationViewDialogComponent reservationViewDialogComponent =
            new ReservationViewDialogComponent();
    ...
    private void openReservationDetails(ReservationDetail reservationDetail) {
        ...
        boolean canMarkPaid = reservationDetail.getReservationStatus() != ReservationStatus.PAID;
        if (markPaidBtn != null) {
